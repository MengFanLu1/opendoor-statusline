...
impl ThemePresets {
    ...
    fn get_themes_path() -> std::path::PathBuf {
        if let Some(home) = dirs::home_dir() {
            home.join(".claude/opendoor-statusline").join("themes")
        } else {
            std::path::PathBuf::from(".claude/opendoor-statusline/themes")
        }
    }
    ...
    pub fn get_cometix() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_cometix::opendoor-statusline_usage_segment(),
                theme_cometix::opendoor-statusline_subscription_segment(),
            ],
    ...
    pub fn get_default() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_default::opendoor-statusline_usage_segment(),
                theme_default::opendoor-statusline_subscription_segment(),
                theme_default::opendoor-statusline_status_segment(),
            ],
    ...
    pub fn get_minimal() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_minimal::opendoor-statusline_usage_segment(),
                theme_minimal::opendoor-statusline_subscription_segment(),
            ],
    ...
    pub fn get_gruvbox() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_gruvbox::opendoor-statusline_usage_segment(),
                theme_gruvbox::opendoor-statusline_subscription_segment(),
            ],
    ...
    pub fn get_nord() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_nord::opendoor-statusline_usage_segment(),
                theme_nord::opendoor-statusline_subscription_segment(),
            ],
    ...
    pub fn get_powerline_dark() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_dark::opendoor-statusline_usage_segment(),
                theme_powerline_dark::opendoor-statusline_subscription_segment(),
            ],
    ...
    pub fn get_powerline_light() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_light::opendoor-statusline_usage_segment(),
                theme_powerline_light::opendoor-statusline_subscription_segment(),
            ],
    ...
    pub fn get_powerline_rose_pine() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_rose_pine::opendoor-statusline_usage_segment(),
                theme_powerline_rose_pine::opendoor-statusline_subscription_segment(),
            ],
    ...
    pub fn get_powerline_tokyo_night() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_tokyo_night::opendoor-statusline_usage_segment(),
                theme_powerline_tokyo_night::opendoor-statusline_subscription_segment(),
            ],
